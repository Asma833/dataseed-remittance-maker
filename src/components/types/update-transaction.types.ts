...
export const StatusKeywords = {
  [StatusCategory.SUCCESS]: ['paid', 'verified', 'approved', 'success', 'completed'],
  [StatusCategory.ERROR]: ['rejected', 'failed', 'error'],
  [StatusCategory.PENDING]: ['pending', 'initiated', 'processing'],
  [StatusCategory.UPLOADED]: ['uploaded'],
  [StatusCategory.UPLOADING]: ['uploading'],
} as const;
...
export interface KycDetails {
  ...
  declared_education_loan_amount: string | null;
  previous_transaction_amount: string | null;
  declared_previous_amount: string | null;
...
export interface DealBooking {
  ...
  created_at: string;
  updated_at: string;
  fx_amount_cust_rate: string;
  transactions: Transaction[];
  payment_records: PaymentRecord[];
}

export type DealBookingList = DealBooking[];
