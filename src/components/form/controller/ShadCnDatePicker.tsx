...
export const ShadCnDatePicker = ({
  ...
  const handleCalendarChange = useCallback((_value: string | number, _e: React.ChangeEventHandler<HTMLSelectElement>) => {
    const _event = {
      target: {
        value: String(_value),
      },
  ...
  const YearsDropdown = useCallback((props: DropdownProps) => {
    return (
      <Select
