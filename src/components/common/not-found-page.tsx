  ...
  return (
    <div className="flex w-full h-full items-center justify-center pt-5">
      <div className="text-center">
        ...
        <a href="/" className="rounded-md bg-blue-500 px-6 py-3 text-white hover:bg-blue-600 transition-colors">
          Go to Homepage
        </a>
        <div className="flex items-center justify-center mt-8">
          <LogoutWrapper>
            <button className="p-2 rounded-full hover:bg-muted/20">logout</button>
          </LogoutWrapper>
        </div>
      </div>
    </div>
