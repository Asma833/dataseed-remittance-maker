...
export const mapDealDetailsApiToFormInput = (apiResponse: DealDetailsApiResponse, dealBookingId: string): InitialData => {
  return {
    ...
    beneficiaryDetails: {
      ...
      intermediary_bank_account_number: apiResponse.beneficiaryDetails.intermediary_bank_account_number || undefined,
      intermediary_bank_swift_code: apiResponse.beneficiaryDetails.intermediary_bank_swift_code || undefined,
      intermediary_bank_name: apiResponse.beneficiaryDetails.intermediary_bank_name || undefined,
      intermediary_bank_address: apiResponse.beneficiaryDetails.intermediary_bank_address || undefined,
    },
    transactionDetails: {
